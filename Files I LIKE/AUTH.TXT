...
// ✅ FIX: Allow email OR username (removed .email() validation)
const loginSchema = z.object({
  email: z.string().trim().min(1, { message: "Enter email or username" }),
  password: z
    .string()
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      toast({
        ...
        description: "Welcome to Pinterest!",
      });
      navigate("/home");
    }
  };
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-foreground">Welcome to Pinterest</h1>
